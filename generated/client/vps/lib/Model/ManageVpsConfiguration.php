 ...
 *
 * @category Class
 * @description Описывает параметры Vps
 * @package  Generated\Client\Vps
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ManageVpsConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['disk_size'] = $data['disk_size'] ?? null;
        $this->container['memory'] = $data['memory'] ?? null;
        $this->container['price_day'] = $data['price_day'] ?? null;
        $this->container['price_month'] = $data['price_month'] ?? null;
     ...
     * Sets name
     *
     * @param string|null $name Имя конфигурации Vps
     *
     * @return self
     */
     ...
     * Sets cpu_count
     *
     * @param int|null $cpu_count Количество ядер процессора, шт
     *
     * @return self
     */
     ...
     * Sets disk_size
     *
     * @param int|null $disk_size Объем дисковой квоты, Мб
     *
     * @return self
     */
     ...
     * Sets memory
     *
     * @param int|null $memory Объем оперативной памяти, Мб
     *
     * @return self
     */
     ...
     * Sets price_day
     *
     * @param double|null $price_day Цена в день
     *
     * @return self
     */
     ...
     * Sets price_month
     *
     * @param double|null $price_month Цена в месяц
     *
     * @return self
     */
     ...
     * Sets available
     *
     * @param bool|null $available Доступен ли для заказа пользователем
     *
     * @return self
     */
     ...
     * Sets custom
     *
     * @param bool|null $custom Является ли конфигурация персональной
     *
     * @return self
     */
